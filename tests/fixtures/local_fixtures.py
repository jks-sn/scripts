...
def local_setup(request, implementation):
    ...
    logger.debug("[local_setup] SETUP replication with implementation=%s", implementation)
    setup_replication(implementation=implementation, ddl=ddl, cascade=cascade)
